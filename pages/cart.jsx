...
<div className=" p-12 flex flex-col">
      ...
      <div className="hover:scale-110 duration-150 p-7 rounded-lg mx-auto mt-10 bg-lime-900 text-white">
        ...
        <p><span className="font-semibold">Subtotal: </span>$79.9</p>
        <p><span className="font-semibold">Discount: </span>$0</p>
        <p className="mb-5"><span className="font-semibold">Total: </span>$79.9</p>
        <input className="w-60 cursor-pointer duration-150 bg-white text-lime-900 px-2 py-1" type="button" value="Checkout Now!" />
      </div>
    </div>  )
}
